...
import { mockListedForSale } from "@/components-data/demo-data"
import { PaymentStatus, paymentStatusConfig } from "../../resources/status-config"
import PaginationControls from "../../tools/PaginationControl"
import { Badge } from "@/components/ui/badge"

export default function ListedForSaleTable() {
    
    const pagination = usePagination(mockListedForSale, 10)
    ...
    return (
        <div className="w-full space-y-4">
                                    ...
                                    >
                                        ...
                                        <td className="p-4">
                                            <p className="text-xs text-brand-secondary-9 font-bold">
                                                ₦{ticket.listingPrice.toLocaleString()}
                                            </p>
                                        </td>
                                        <td className="p-4">
            ...
            <PaginationControls
                ...
                totalItems={mockListedForSale.length}
