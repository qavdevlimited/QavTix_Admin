...
import { EventStatus, getEventsListingAllEvents } from "@/components/custom-utils/dropdown/resources/management-actions"
...
export default function LiveEventsTable() {
    ...
    const pagination = usePagination(mockUpcomingEvents.filter(v => v.status === "live"), 10)
                            ...
                            {pagination.currentItems.map((event) => (
                                <tr 
                                    ...
                                    <td className="py-4 px-4 text-right">
                                        <TableItemDropdown id={event.id} actions={getEventsListingAllEvents(event.status as any, event.id, router)} />
                                    </td>
                                </tr>
                            ))}
                        </tbody>
