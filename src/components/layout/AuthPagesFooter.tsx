...
export default function AuthPagesFooter() {
    ...
    return (
        ...
        <footer className="w-full py-10 md:px-24">
            <div className="max-w-7xl w-full mx-auto px-6">
                <div className="flex flex-col md:flex-row items-center text-xs md:text-sm justify-between gap-6 text-brand-neutral-8">
