...
const STATUS_CONFIG: Record<string, { text: string; bg: string; label?: string }> = {
    "filling_fast": { bg: "bg-warning-tertiary", text: "text-secondary-9", label: "Filling fast" },
    "selling_fast": { bg: "bg-warning-tertiary", text: "text-secondary-9", label: "Selling fast" },
    "near_capacity": { bg: "bg-danger-tertiary", text: "text-secondary-9", label: "Near capacity" },
    new: { bg: "bg-accent-6", text: "text-white", label: "New" },
    "sold_out": { bg: "bg-white border border-danger-default/20", text: "text-danger-default", label: "Sold out" },
    "starts_soon": { bg: "bg-primary-1", text: "text-primary-9", label: "Starts soon" },
    started: { bg: "bg-primary-1", text: "text-primary-9", label: "Started" },
